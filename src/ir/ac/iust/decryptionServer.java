...
public class decryptionServer {
    public static void main(String[] args) throws IOException {
        ServerSocket welcomeSocket = new ServerSocket(1378);
        System.out.println("Decryption Server is running on port 1378");
        ...
        while (true) {
            try {
                ...
                new ClientHandler2(connectionSocket, inputStream, outputStream).start();
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
